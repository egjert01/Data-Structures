...
private:
        ...
        bool  remove(Node *node, int value);
            bool findRemoveLeft(Node *node, int value);
            bool findRemoveRight(Node *node, int value);
            void removeRoot();
            void removeHelper(Node *parent, Node *node, bool left);
            void removeSingleChildLeft(Node *node, Node *parent, Node *deleter, 
                                        bool left);
            void removeSingleChildRight(Node *node, Node *parent, Node *deleter,
                                        bool left);
        ...
        int maximum(int value, int value2) const;
        Node *makeNode(int value);
        Node *makeNode(int value, int count, Node *r, Node *l) const;
